...
//** 钱包找回支付密码-设置支付密码 */
static NSString *MYWALLETMODIFYPASSWORD_URL = @"/api/wallet/payPwdSet";
//** 钱包找回支付密码-获取验证码 */
static NSString *RESETPASSWORDSENDMESSAGE_URL = @"/api/wallet/bankPayPwdSet";
/**
 *  查询银行卡类型
 */
...
//** 重置密码 校验 token */
static NSString *RESETPASSWORDCHECKTOKEN_URL = @"/api/wallet/payPwdVerify";
 ...
 *  钱包-收支明细列表
 */
static NSString *WALLETEXPENSLIST_URL = @"/api/wallet/expense/list";

/**
 *  钱包-收支明细详情
 */
static NSString *WALLETEXPENSDETAIL_URL = @"/api/wallet/orderQuery";
//修改证件有效期 发短信 借口
static NSString *CHANGEIDCARDOUTTIMEGETSMSCODE_URL =@"/api/wallet/smsSend";
//修改证件有效期。 提交数据接口
static NSString *CHANGEIDCARDOUTCOMMITDATA_URL = @"/api/wallet/validModifyuserinfo";
