//
//  ZYNumberKeyboard.m
//  ZYNumberKeyboardDemo
//
//  Created by william on 16/11/17.
//  Copyright © 2016年 常振延. All rights reserved.
//
...
- (id)init
{
    ...
    if(self)
    {
        ...
        [[NSBundle mainBundle] loadNibNamed:@"ZYNumberKeyboard" owner:self options:nil];
        ...
        // 设置图片
        [self.mDeleteBtn setImage:[UIImage imageNamed:@"ZYNumberKeyboard.bundle/delete.png"]
                        forState:UIControlStateNormal];
        [self.mResignBtn setImage:[UIImage imageNamed:@"ZYNumberKeyboard.bundle/resign.png"]
                        forState:UIControlStateNormal];
    }
