...
/** 默认的列数 */
static const NSInteger YXDefaultColumnCount = 2;
/** 每一列之间的间距 */
static const CGFloat YXDefaultColumnMargin = 10;
/** 每一行之间的间距 */
static const CGFloat YXDefaultRowMargin = 10;
/** 边缘间距 */
static const UIEdgeInsets YXDefaultEdgeInsets = {10, 10, 10, 10};


@interface YXWaterfallFlowLayout()
...
@implementation YXWaterfallFlowLayout
...
//    attr.size = CGSizeMake(YXScreenW, 44);
//    
//    return attr;
